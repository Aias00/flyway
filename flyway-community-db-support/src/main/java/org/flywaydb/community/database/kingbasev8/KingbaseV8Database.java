...
public class KingbaseV8Database extends Database<KingbaseV8Connection> {
    public KingbaseV8Database(Configuration configuration, JdbcConnectionFactory jdbcConnectionFactory, StatementInterceptor statementInterceptor) {
        super(configuration, jdbcConnectionFactory, statementInterceptor);
    }

    @Override
    protected KingbaseV8Connection doGetConnection(Connection connection) {
        return new KingbaseV8Connection(this, connection);
    }
