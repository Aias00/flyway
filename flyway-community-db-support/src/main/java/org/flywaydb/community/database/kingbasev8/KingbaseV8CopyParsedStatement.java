 ...
 */
public class KingbaseV8CopyParsedStatement extends ParsedSqlStatement {
    /**
     ...
     */
    public KingbaseV8CopyParsedStatement(int pos, int line, int col, String sql, String copyData) {
