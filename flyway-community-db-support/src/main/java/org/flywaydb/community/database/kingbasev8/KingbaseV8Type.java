 ...
 */
public class KingbaseV8Type extends Type<KingbaseV8Database, KingbaseV8Schema> {
    /**
     ...
     */
    public KingbaseV8Type(JdbcTemplate jdbcTemplate, KingbaseV8Database database, KingbaseV8Schema schema, String name) {
