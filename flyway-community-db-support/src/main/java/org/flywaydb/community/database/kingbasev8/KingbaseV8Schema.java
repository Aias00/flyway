 ...
 */
public class KingbaseV8Schema extends Schema<KingbaseV8Database, KingbaseV8Table> {
    /**
     ...
     */
    protected KingbaseV8Schema(JdbcTemplate jdbcTemplate, KingbaseV8Database database, String name) {
    ...
    @Override
    protected KingbaseV8Table[] doAllTables() throws SQLException {
        ...
        KingbaseV8Table[] tables = new KingbaseV8Table[tableNames.size()];
        for (int i = 0; i < tableNames.size(); i++) {
            tables[i] = new KingbaseV8Table(jdbcTemplate, database, this, tableNames.get(i));
        }
        return tables;
    }
    ...
    public Table getTable(String tableName) {
        return new KingbaseV8Table(jdbcTemplate, database, this, tableName);
    }

    @Override
    protected Type getType(String typeName) {
        return new KingbaseV8Type(jdbcTemplate, database, this, typeName);
    }
}