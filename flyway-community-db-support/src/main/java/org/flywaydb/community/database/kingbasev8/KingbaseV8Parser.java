...
@CustomLog
public class KingbaseV8Parser extends Parser {
    ...
    public KingbaseV8Parser(Configuration configuration, ParsingContext parsingContext) {
    ...
    protected ParsedSqlStatement createStatement(PeekingReader reader, Recorder recorder,
        ...
        if (statementType == COPY) {
            return new KingbaseV8CopyParsedStatement(nonCommentPartPos, nonCommentPartLine, nonCommentPartCol,
